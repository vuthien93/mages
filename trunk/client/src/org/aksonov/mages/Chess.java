...
/**
 * This main activity for Chess game provides method to return layout with chess
 * board and chess type used by intent filters.
 * 
 * @author aksonov
 */
public class Chess extends Game {
	...
	public int getBoardLayout() {
		...
		if (height > width) {
			return R.layout.chess_vertical;
		} else {
			return R.layout.chess_horizontal;
		}
	}
